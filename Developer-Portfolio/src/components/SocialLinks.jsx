...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "Live projects on Vercel",
    icon: Globe,
    url: "https://mockmate-app-cyan.vercel.app/",
    color: "#FF4500",
    gradient: "from-[#FF4500] to-[#FF0080]"
  },
  {
    name: "Certificates",
...
const SocialLinks = () => {
  ...
  const PrimaryIcon = linkedIn.icon;
